class MediaDirectorySerializer < MediaAbstractFileSerializer
  def build json, options = {}
    ...
    json.unanalyzedFilesCount record.unanalyzed_files_count

    if options[:include_media_search] && media_search = record.media_search
      json.mediaSearch serialize(media_search)
    end
  end
end
