class AnalyzeMediaFileJob < AbstractAnalyzeMediaFilesJob
  ...
  def self.perform media_file_id, event_id
    ...
    perform_analysis relation: relation, job_args: [ media_file_id ], event: event, analysis_event_type: 'media:analysis:file', analysis_user: media_file.source.user, cause: media_file
  end
end
