class AnalyzeMediaScanJob < AbstractAnalyzeMediaFilesJob
  ...
  def self.perform media_scan_id, event_id
    ...
    perform_analysis relation: files_to_analyze_rel, job_args: [ media_scan_id ], event: event, analysis_event_type: 'media:analysis:scan', analysis_user: media_scan.source.user, cause: media_scan, clear_errors: true do
