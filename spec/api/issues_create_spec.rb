...
RSpec.describe 'POST /api/items' do
  ...
  let!(:work){ create :work, category: 'magazine', language: languages[0], start_year: 2000, end_year: 2001, creator: creator }
  ...
  describe "with a work that has no start or end year" do
    let!(:work){ create :work, category: 'magazine', language: languages[0], start_year: nil, end_year: nil, creator: creator }
